...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DysyyiXx.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DlTQ3Vpf.mjs"),
		import("./start-BSNKTS_f.mjs"),
		import("./empty-plugin-adapters-CN2hFfTw.mjs")
	]);
	return {
		routerEntry,
		startEntry,
