...
import { $ as type, B as array, D as CommonClient, E as keccak_256, F as fetch$1, G as instance, H as coerce, I as init_lib, J as number, K as literal, O as WebSocket, Q as tuple, R as require_browser, T as init_sha3, U as create, V as boolean, W as init_dist, X as record, Y as optional, Z as string, at as require_Layout, b as secp256k1, ct as sha256, d as PublicKey$1, dt as ed25519, et as union, ft as init_ed25519, it as init_index_node, k as init_dist$1, lt as require_bs58, nt as getU64Codec, ot as require_lib, q as nullable, rt as getU64Encoder, st as init_sha256, tt as unknown, ut as require_bn, v as init_index_esm, y as init_secp256k1, z as any } from "../@coral-xyz/anchor.mjs";
import { Buffer as Buffer$1 } from "buffer";
import require$$0 from "util";
import require$$0$1 from "http";
import require$$0$2, { Agent } from "https";
import { toBigIntLE, toBufferLE } from "bigint-buffer";
//#region ../../node_modules/.pnpm/@dynamic-labs+logger@4.89.0/node_modules/@dynamic-labs/logger/_virtual/_tslib.js
/******************************************************************************
...
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+logger@4.89.0/node_modules/@dynamic-labs/logger/src/utils/deepMerge.js
...
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+logger@4.89.0/node_modules/@dynamic-labs/logger/src/MetaData/MetaData.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+logger@4.89.0/node_modules/@dynamic-labs/logger/src/types.js
var LogLevel;
(function(LogLevel) {
...
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+logger@4.89.0/node_modules/@dynamic-labs/logger/src/utils/createCircularReferenceReplacer.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+logger@4.89.0/node_modules/@dynamic-labs/logger/src/utils/mapLogLevel.js
var mapLogLevel = (level) => {
	if (level in LogLevel && typeof level === "string") return LogLevel[level];
	else if (level in LogLevel && typeof level === "number") return level;
	else throw new Error(`Invalid log level: ${level}`);
};
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+logger@4.89.0/node_modules/@dynamic-labs/logger/src/utils/processArgs.js
/**
...
var processArgs = (message) => {
	return {
		objectArgs: message.args.filter((arg) => typeof arg === "object"),
		remainingArgs: message.args.filter((arg) => typeof arg !== "object" || arg instanceof Error).map((arg) => {
			var _a;
			return (_a = arg === null || arg === void 0 ? void 0 : arg.toString) === null || _a === void 0 ? void 0 : _a.call(arg);
		})
	};
};
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+logger@4.89.0/node_modules/@dynamic-labs/logger/src/utils/getStack.js
var getStack = (constructorOpt) => {
	...
	if (stack && constructorOpt) return stack.split("\n").slice(2).join("\n");
	return stack;
};
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+logger@4.89.0/node_modules/@dynamic-labs/logger/src/index.js
...
var Logger = class Logger {
	...
	constructor(name, level) {
		...
		if (typeof window !== "undefined" && window.localStorage !== void 0) {
			Logger.troubleshootModeEnabled = Logger.troubleshootModeEnabled || window.localStorage.getItem("dynamic_enableTroubleshootMode") === "true";
	...
	static setEmitErrors(emit) {
		if (emit !== void 0) globalState.keys.emitErrors = emit;
	}
	static setEnvironmentId(environmentId) {
		if (environmentId !== void 0) globalState.keys.environmentId = environmentId;
	}
	getNameArray(name) {
	...
	get level() {
		var _a;
		if (globalState.logLevel && !this._level) return globalState.logLevel;
		if (this._level === void 0 && typeof process !== "undefined" && ((_a = process.env) === null || _a === void 0 ? void 0 : _a["NODE_ENV"]) !== "production") return LogLevel.DEBUG;
		if (this._level === void 0) return LogLevel.WARN;
		return this._level;
	}
	formatMessage(level, message) {
		var _a;
		if (message instanceof Error) message = message.stack;
		else if (message instanceof Object && Object.prototype.hasOwnProperty.call(message, "stack")) message = message.stack;
		else if (message instanceof Object) message = JSON.stringify(message, createCircularReferenceReplacer());
		return `${(Array.isArray(this.name) ? this.name : [this.name]).map((name) => `[${name}]`).join("")} [${(_a = LogLevel[level]) !== null && _a !== void 0 ? _a : "TROUBLESHOOTING"}]: ${message}`;
	}
	captureAndSend(level, message, ...args) {
		return __awaiter$3(this, void 0, void 0, function* () {
			if (globalState.keys.emitErrors && !IGNORE_MESSAGES.includes(message === null || message === void 0 ? void 0 : message.toString()) && typeof window !== "undefined") this.emitHttpLogs(level, message, { args });
		});
	}
 ...
 /**
		...
		*/
		queueMicrotask(() => __awaiter$3(this, void 0, void 0, function* () {
			...
			try {
				if (!globalState.keys.environmentId) throw new Error("Environment ID not set");
	...
	*/
	...
	log(level, message, ...args) {
		if (!(typeof window !== "undefined" && Logger.troubleshootModeEnabled) && (level < this.level || level === LogLevel.MUTE)) return;
		...
		switch (level) {
			...
			case LogLevel.ERROR:
				...
				break;
			default: console.log(fmtMsg, ...args);
		}
		if (level === LogLevel.ERROR) this.captureAndSend(level, message, ...args);
	}
...
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+utils@4.89.0/node_modules/@dynamic-labs/utils/src/errors/CustomError.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+utils@4.89.0/node_modules/@dynamic-labs/utils/src/errors/DynamicError.js
var DynamicError = class extends CustomError {};
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+utils@4.89.0/node_modules/@dynamic-labs/utils/src/errors/NotSupportedError.js
var NotSupportedError = class extends DynamicError {};
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+utils@4.89.0/node_modules/@dynamic-labs/utils/_virtual/_tslib.js
/******************************************************************************
Copyright (c) Microsoft Corporation.
...
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+utils@4.89.0/node_modules/@dynamic-labs/utils/src/errors/WalletAddressMismatchError.js
...
//#endregion
//#region ../../node_modules/.pnpm/tldts-core@6.1.86/node_modules/tldts-core/dist/es6/src/domain.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/tldts-core@6.1.86/node_modules/tldts-core/dist/es6/src/domain-without-suffix.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/tldts-core@6.1.86/node_modules/tldts-core/dist/es6/src/extract-hostname.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/tldts-core@6.1.86/node_modules/tldts-core/dist/es6/src/is-ip.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/tldts-core@6.1.86/node_modules/tldts-core/dist/es6/src/is-valid.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/tldts-core@6.1.86/node_modules/tldts-core/dist/es6/src/options.js
...
//#endregion
//#region ../../node_modules/.pnpm/tldts-core@6.1.86/node_modules/tldts-core/dist/es6/src/subdomain.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/tldts-core@6.1.86/node_modules/tldts-core/dist/es6/src/factory.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/tldts-core@6.1.86/node_modules/tldts-core/dist/es6/src/lookup/fast-path.js
...
//#endregion
//#region ../../node_modules/.pnpm/tldts@6.0.16/node_modules/tldts/dist/es6/src/data/trie.js
...
var rules = (function() {
	const _2 = [1, {}], _3 = [2, {}], _4 = [1, {
		...
		"net": _2,
		"edu": _2
	}], _5 = [0, { "*": _3 }], _6 = [1, { "blogspot": _3 }], _7 = [1, { "gov": _2 }], _8 = [0, { "*": _2 }], _9 = [0, { "cloud": _3 }], _10 = [1, { "co": _3 }], _11 = [2, { "nodes": _3 }], _12 = [0, { "s3": _3 }], _13 = [0, { "direct": _3 }], _14 = [2, { "id": _3 }], _15 = [0, { "webview-assets": _3 }], _16 = [0, {
		"vfs": _3,
		"webview-assets": _3
	}], _17 = [0, {
		"aws-cloud9": _15,
		...
		"aws-cloud9": _15,
		"cloud9": _16
	}], _21 = [0, { "apps": _3 }], _22 = [0, { "paas": _3 }], _23 = [0, { "app": _3 }], _24 = [2, { "eu": _3 }], _25 = [0, { "site": _3 }], _26 = [0, { "pages": _3 }], _27 = [1, {
		"com": _2,
		"edu": _2,
		"net": _2,
		"org": _2
	}], _28 = [0, { "j": _3 }], _29 = [0, { "jelastic": _3 }], _30 = [0, { "user": _3 }], _31 = [1, { "ybo": _3 }], _32 = [0, {
		"cust": _3,
		"reservd": _3
	}], _33 = [0, { "cust": _3 }], _34 = [1, {
		"gov": _2,
		...
		"gov": _2,
		"blogspot": _3
	}], _37 = [1, { "framer": _3 }], _38 = [1, { "barsy": _3 }], _39 = [0, { "forgot": _3 }], _40 = [1, { "gs": _2 }], _41 = [0, { "nes": _2 }], _42 = [1, {
		"k12": _2,
		"cc": _2,
		"lib": _2
	}], _43 = [1, {
...
//#endregion
//#region ../../node_modules/.pnpm/tldts@6.0.16/node_modules/tldts/dist/es6/src/suffix-trie.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+utils@4.89.0/node_modules/@dynamic-labs/utils/src/services/PlatformService/createBrowserPlatformService/createBrowserPlatformService.js
var createBrowserPlatformService = (window) => ({
	downloadFile: (fileName, file) => __awaiter$2(void 0, void 0, void 0, function* () {
	...
	getTLD: (domain) => {
		return parse(domain || window.location.hostname, { allowPrivateDomains: true }).domain || void 0;
	},
	getUrl: () => new URL(window.location.href),
	isNativeMobile: false,
	isWaasSecureStorageSupported: false,
	openURL: (url_1, ...args_1) => __awaiter$2(void 0, [url_1, ...args_1], void 0, function* (url, target = "self", features = "") {
		if (target === "blank") window.open(url, "_blank", features);
		else window.location.assign(url);
	})
});
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+utils@4.89.0/node_modules/@dynamic-labs/utils/src/services/PlatformService/PlatformService.js
var _a, _PlatformService_implementation;
var PlatformService = class {
	static get implementation() {
		if (!__classPrivateFieldGet$1(_a, _a, "f", _PlatformService_implementation)) return createBrowserPlatformService(window);
		return __classPrivateFieldGet$1(_a, _a, "f", _PlatformService_implementation);
	}
...
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+utils@4.89.0/node_modules/@dynamic-labs/utils/src/isMobile/isMobile.js
/**
...
var isLegacySafari = () => {
	if (typeof window === "undefined" || !window.CSS || typeof window.CSS.supports !== "function") return false;
...
var getAndroidVersion = () => {
	...
	if (!androidVersionMatch) return;
	return parseFloat(androidVersionMatch[1]);
};
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+utils@4.89.0/node_modules/@dynamic-labs/utils/src/isLedgerAddressViaVerifiedCredentials/isLedgerAddressViaVerifiedCredentials.js
var isLedgerAddressViaVerifiedCredentials = (address, verifiedCredentials) => {
	return verifiedCredentials.filter((v) => {
		var _a;
		return ((_a = v.walletProperties) === null || _a === void 0 ? void 0 : _a.hardwareWallet) === "ledger";
	}).map((v) => v.address).includes(address);
};
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+utils@4.89.0/node_modules/@dynamic-labs/utils/src/cloneObjectWithOverrides/cloneObjectWithOverrides.js
/**
...
var cloneObjectWithOverrides = (original, overrides = {}) => {
	...
	for (const [key, value] of Object.entries(overrides)) Object.defineProperty(clone, key, {
		configurable: true,
	...
	for (const [key, descriptor] of Object.entries(descriptors)) if (!overridesKeys.includes(key)) Object.defineProperty(clone, key, descriptor);
	return clone;
};
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+utils@4.89.0/node_modules/@dynamic-labs/utils/src/template/template.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+types@4.89.0/node_modules/@dynamic-labs/types/src/wallets/BaseWallet.js
...
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+utils@4.89.0/node_modules/@dynamic-labs/utils/src/parseAmountToSmallestUnit/parseAmountToSmallestUnit.js
/**
...
*/
var parseAmountToSmallestUnit = ({ amount, decimals }) => {
	const [whole, fraction = ""] = amount.split(".");
	const paddedFraction = fraction.padEnd(decimals, "0").slice(0, decimals);
	return BigInt((whole || "0") + paddedFraction);
};
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+utils@4.89.0/node_modules/@dynamic-labs/utils/src/solToLamports/solToLamports.js
var solToLamports = (solAmount) => {
	return solAmount * 1e9;
};
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+wallet-connector-core@4.89.0_@dynamic-labs-wallet+primitives@1.0.16_buffe_f795b07e227478935642fb6d19774621/node_modules/@dynamic-labs/wallet-connector-core/src/events/walletConnectorEvents.js
var walletConnectorEvents = new eventemitter3_default();
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+wallet-connector-core@4.89.0_@dynamic-labs-wallet+primitives@1.0.16_buffe_f795b07e227478935642fb6d19774621/node_modules/@dynamic-labs/wallet-connector-core/src/utils/logger.js
var logger = new Logger("WalletConnector");
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+wallet-connector-core@4.89.0_@dynamic-labs-wallet+primitives@1.0.16_buffe_f795b07e227478935642fb6d19774621/node_modules/@dynamic-labs/wallet-connector-core/src/utils/shouldLowercaseAddress.js
...
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+wallet-connector-core@4.89.0_@dynamic-labs-wallet+primitives@1.0.16_buffe_f795b07e227478935642fb6d19774621/node_modules/@dynamic-labs/wallet-connector-core/src/utils/isSameAddress/utils/normalizeAddress/normalizeAddress.js
var normalizeAddress = (rawAddress, chain) => {
	let address = rawAddress;
	if (address === null || address === void 0 ? void 0 : address.startsWith("0x")) address = address.slice(2);
	address = shouldLowercaseAddress(chain) ? address === null || address === void 0 ? void 0 : address.toLowerCase() : address;
	return address;
};
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+wallet-connector-core@4.89.0_@dynamic-labs-wallet+primitives@1.0.16_buffe_f795b07e227478935642fb6d19774621/node_modules/@dynamic-labs/wallet-connector-core/src/utils/isSameAddress/isSameAddress.js
var isSameAddress = (left, right, chain) => normalizeAddress(left, chain) === normalizeAddress(right, chain);
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+wallet-connector-core@4.89.0_@dynamic-labs-wallet+primitives@1.0.16_buffe_f795b07e227478935642fb6d19774621/node_modules/@dynamic-labs/wallet-connector-core/_virtual/_tslib.js
/******************************************************************************
Copyright (c) Microsoft Corporation.
...
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+wallet-connector-core@4.89.0_@dynamic-labs-wallet+primitives@1.0.16_buffe_f795b07e227478935642fb6d19774621/node_modules/@dynamic-labs/wallet-connector-core/src/utils/isHex/isHex.js
var isHex = (value) => {
...
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+wallet-connector-core@4.89.0_@dynamic-labs-wallet+primitives@1.0.16_buffe_f795b07e227478935642fb6d19774621/node_modules/@dynamic-labs/wallet-connector-core/src/utils/eventListenerHandlers.js
var eventListenerHandlers = (walletConnector) => {
	const handleAccountChange = (accounts) => __awaiter$1(void 0, void 0, void 0, function* () {
	...
	const handleChainChange = (chain) => __awaiter$1(void 0, void 0, void 0, function* () {
		logger.debug(`${walletConnector.name} - chainChange`, chain);
		const chainStr = isHex(chain) ? parseInt(chain, 16).toString() : chain.toString();
		walletConnector.emit("chainChange", { chain: chainStr });
	});
	const handleDisconnect = (error) => __awaiter$1(void 0, void 0, void 0, function* () {
		logger.debug(`${walletConnector.name} - disconnect`, error);
		if ((error === null || error === void 0 ? void 0 : error.code) === 1013) return;
		walletConnector.emit("disconnect");
	});
	return {
		handleAccountChange,
...
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+wallet-book@4.89.0_react-dom@19.2.7_react@19.2.7__react@19.2.7/node_modules/@dynamic-labs/wallet-book/src/helpers/getWalletBookWallet.js
var getWalletBookWallet = (walletBook, walletKey, walletFallback) => {
	...
	if (!walletData) throw new Error(`Wallet ${walletKey} not found in wallet book (${Object.keys((_c = walletBook === null || walletBook === void 0 ? void 0 : walletBook.wallets) !== null && _c !== void 0 ? _c : {}).length} wallets found)`);
	return walletData;
};
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+iconic@4.89.0_react-dom@19.2.7_react@19.2.7__react@19.2.7/node_modules/@dynamic-labs/iconic/src/helpers/getIconicSpriteUrl.js
var DEFAULT_ICONIC_SPRITE_URL = "https://iconic.dynamic-static-assets.com/icons/sprite.svg";
var getIconicSpriteUrl = () => {
	var _a, _b, _c;
	if (typeof process !== "undefined" && process.env) return (_c = (_b = (_a = process.env["ICONIC_SPRITE_CDN_URL"]) !== null && _a !== void 0 ? _a : process.env["NEXT_PUBLIC_ICONIC_SPRITE_CDN_URL"]) !== null && _b !== void 0 ? _b : process.env["REACT_APP_ICONIC_SPRITE_CDN_URL"]) !== null && _c !== void 0 ? _c : DEFAULT_ICONIC_SPRITE_URL;
	return DEFAULT_ICONIC_SPRITE_URL;
};
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+wallet-book@4.89.0_react-dom@19.2.7_react@19.2.7__react@19.2.7/node_modules/@dynamic-labs/wallet-book/src/helpers/renderTemplate.js
var TEMPLATES = {
...
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+wallet-book@4.89.0_react-dom@19.2.7_react@19.2.7__react@19.2.7/node_modules/@dynamic-labs/wallet-book/src/helpers/findWalletBookWallet.js
var findWalletBookWallet = (walletBook, walletKey) => {
	try {
		return getWalletBookWallet(walletBook, walletKey);
	} catch (err) {
		return;
	}
};
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+wallet-book@4.89.0_react-dom@19.2.7_react@19.2.7__react@19.2.7/node_modules/@dynamic-labs/wallet-book/src/helpers/isWalletBookPopulated.js
...
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+wallet-connector-core@4.89.0_@dynamic-labs-wallet+primitives@1.0.16_buffe_f795b07e227478935642fb6d19774621/node_modules/@dynamic-labs/wallet-connector-core/src/utils/getMobileExperience/getMobileExperience.js
/**
...
var getMobileExperienceFromProp = ({ mobileExperienceProp, walletKey }) => {
	if (!mobileExperienceProp) return;
	if (typeof mobileExperienceProp === "string") return mobileExperienceProp;
	if (mobileExperienceProp[walletKey]) return mobileExperienceProp[walletKey];
	if (mobileExperienceProp.default) return mobileExperienceProp.default;
};
/**
...
var getMobileExperience = ({ mobileExperienceProp, walletBook, walletKey, walletConnector }) => {
	...
	if (mobileExperienceFromProp && (supportsRedirect || mobileExperienceFromProp !== "redirect")) return mobileExperienceFromProp;
	const walletBookRecord = findWalletBookWallet(walletBook, walletKey);
	logger.logVerboseTroubleshootingMessage("[getMobileExperience]", {
		isWalletConnect: walletConnector.isWalletConnect,
		walletBookRecord
	});
	if (walletBookRecord === null || walletBookRecord === void 0 ? void 0 : walletBookRecord.mobileExperience) return walletBookRecord.mobileExperience;
	if (walletKey === "metamask") return "redirect";
	if (walletConnector.isWalletConnect) return "redirect";
	return "in-app-browser";
};
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+wallet-connector-core@4.89.0_@dynamic-labs-wallet+primitives@1.0.16_buffe_f795b07e227478935642fb6d19774621/node_modules/@dynamic-labs/wallet-connector-core/src/utils/getWalletMetadataFromWalletBook/getDeepLinks/getDeepLinks.js
...
var getDeepLinks = ({ mobile, desktop }) => {
	...
	if (!mobileDeepLinks && !desktopDeepLinks) return;
	return {
...
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+wallet-connector-core@4.89.0_@dynamic-labs-wallet+primitives@1.0.16_buffe_f795b07e227478935642fb6d19774621/node_modules/@dynamic-labs/wallet-connector-core/src/utils/getWalletMetadataFromWalletBook/getDownloadLinks/getDownloadLinks.js
...
var getDownloadLinks = (wallet) => {
	...
	if (!mobileLinks && !desktopLinks) return;
	return Object.assign(Object.assign({}, mobileLinks), desktopLinks);
};
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+wallet-connector-core@4.89.0_@dynamic-labs-wallet+primitives@1.0.16_buffe_f795b07e227478935642fb6d19774621/node_modules/@dynamic-labs/wallet-connector-core/src/utils/getWalletMetadataFromWalletBook/getIconUrl/getIconUrl.js
var getIconUrl = (spriteId) => {
	if (!spriteId) return renderTemplate("iconicUrl", "defaultwallet");
	return renderTemplate("iconicUrl", spriteId);
};
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+wallet-connector-core@4.89.0_@dynamic-labs-wallet+primitives@1.0.16_buffe_f795b07e227478935642fb6d19774621/node_modules/@dynamic-labs/wallet-connector-core/src/utils/getWalletMetadataFromWalletBook/getValidHexColor/getValidHexColor.js
var getValidHexColor = (color) => {
	if (!color) return;
	return /^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/.test(color) ? color : void 0;
};
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+wallet-connector-core@4.89.0_@dynamic-labs-wallet+primitives@1.0.16_buffe_f795b07e227478935642fb6d19774621/node_modules/@dynamic-labs/wallet-connector-core/src/utils/getWalletMetadataFromWalletBook/getWalletLimitations/getWalletLimitations.js
var getWalletLimitations = (walletLimitations) => {
	if (!(walletLimitations === null || walletLimitations === void 0 ? void 0 : walletLimitations.browserExtension)) return;
...
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+wallet-connector-core@4.89.0_@dynamic-labs-wallet+primitives@1.0.16_buffe_f795b07e227478935642fb6d19774621/node_modules/@dynamic-labs/wallet-connector-core/src/utils/getWalletMetadataFromWalletBook/getWalletMetadataFromWalletBook.js
var getWalletMetadataFromWalletBook = ({ walletKey, walletBookWallet, walletBook, walletFallback }) => {
	...
	try {
		...
		logger.debug("Error getting wallet metadata from wallet book", { error: e });
		return;
	}
};
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+wallet-connector-core@4.89.0_@dynamic-labs-wallet+primitives@1.0.16_buffe_f795b07e227478935642fb6d19774621/node_modules/@dynamic-labs/wallet-connector-core/src/utils/isConnectorMethodSupported/isConnectorMethodSupported.js
...
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+wallet-connector-core@4.89.0_@dynamic-labs-wallet+primitives@1.0.16_buffe_f795b07e227478935642fb6d19774621/node_modules/@dynamic-labs/wallet-connector-core/src/Wallet/Wallet.js
var Wallet = class extends BaseWallet {
	...
	*/
	isConnected() {
		return __awaiter$1(this, void 0, void 0, function* () {
			try {
				return (yield this._connector.getConnectedAccounts()).map((address) => normalizeAddress(address, this.chain)).includes(normalizeAddress(this.address, this.chain));
			} catch (error) {
	...
	*/
	signMessage(messageToSign) {
		return __awaiter$1(this, void 0, void 0, function* () {
			yield this.sync();
			return this._connector.signMessage(messageToSign, { address: this.address });
		});
	}
	/**
	...
	*/
	switchNetwork(networkChainId) {
		return __awaiter$1(this, void 0, void 0, function* () {
			return this._connector.switchNetwork({ networkChainId });
		});
	}
	/**
...
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+wallet-connector-core@4.89.0_@dynamic-labs-wallet+primitives@1.0.16_buffe_f795b07e227478935642fb6d19774621/node_modules/@dynamic-labs/wallet-connector-core/src/WalletBookSingleton/WalletBookSingleton.js
var WalletBookSingleton = class WalletBookSingleton {
	constructor(walletBook) {
		this.walletBook = walletBook;
	}
	static getOrCreate(walletBook) {
		var _a;
		if (!((_a = WalletBookSingleton.instance) === null || _a === void 0 ? void 0 : _a.walletBook)) WalletBookSingleton.instance = new WalletBookSingleton(walletBook);
		return WalletBookSingleton.instance;
	}
	static reset() {
		WalletBookSingleton.instance = void 0;
	}
};
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+wallet-connector-core@4.89.0_@dynamic-labs-wallet+primitives@1.0.16_buffe_f795b07e227478935642fb6d19774621/node_modules/@dynamic-labs/wallet-connector-core/src/WalletConnectorBase/WalletConnectorBase.js
var _WalletConnectorBase_registeredExtensions;
var WalletConnectorBase = class WalletConnectorBase extends eventemitter3_default {
	createWallet(props) {
		return new this.ChainWallet(props);
	}
	/**
	...
	*/
	constructor(props) {
		...
		*/
		...
		if (this.walletBook === void 0) throw new Error("WalletConnectorBase was not called with super(props) and is missing wallet-book");
	}
	extend(extension, settings) {
		if (__classPrivateFieldGet(this, _WalletConnectorBase_registeredExtensions, "f").includes(extension.name)) throw new Error(`You can only register a single extension of: ${extension.name}`);
	...
	*/
	...
	get metadata() {
		...
		if (!this._metadata) {
			...
			if (walletBookMetadata || this._constructorMetadata) this._metadata = Object.assign(Object.assign({
				icon: "",
				id: this.key,
				name: this.name
			}, walletBookMetadata), this._constructorMetadata);
		}
	...
	*/
	handleWalletNotActive(_a) {
		return __awaiter$1(this, arguments, void 0, function* ({ activeAddress, expectedAddress, reconnectedAddress }) {
			...
			if (!walletUiUtils) throw new WalletAddressMismatchError(`Wallet ${expectedAddress !== null && expectedAddress !== void 0 ? expectedAddress : ""} is not currently active in ${this.name || this.key}.`, {
	...
	*/
	validateActiveWallet(expectedAddress) {
		return __awaiter$1(this, void 0, void 0, function* () {
			...
			logger.debug("validateActiveWallet - getting connected accounts", { canFetchConnectedAccounts });
			const [activeAddress] = canFetchConnectedAccounts ? yield this.getConnectedAccounts() : [];
			if (activeAddress && isSameAddress(activeAddress, expectedAddress, this.connectedChain)) {
				logger.debug("validateActiveWallet - wallet is active");
				return;
			}
			logger.debug("validateActiveWallet - trying to reconnect wallet...");
			const getReconnectedAddress = () => __awaiter$1(this, void 0, void 0, function* () {
				if (!this.canHandleMultipleConnections || !this.canGetChainAddress()) return;
	...
	*/
	openInAppBrowserIfRequired() {
		var _a;
		if (this.isInstalledOnBrowser() || !isMobile() || !((_a = this.metadata) === null || _a === void 0 ? void 0 : _a.inAppBrowserUrl) || this.mobileExperience === "redirect") return false;
		const inAppBrowserCompiledTemplate = template(this.metadata.inAppBrowserUrl);
		const { href } = PlatformService.getUrl();
		const deepLink = inAppBrowserCompiledTemplate({ encodedDappURI: encodeURIComponent(href) });
...
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+solana-core@4.89.0_@dynamic-labs-wallet+primitives@1.0.16_bufferutil@4.1._dc4aa6854ef4161dca3d011934dd96b7/node_modules/@dynamic-labs/solana-core/_virtual/_tslib.js
/******************************************************************************
Copyright (c) Microsoft Corporation.
...
//#endregion
//#region ../../node_modules/.pnpm/@solana+web3.js@1.98.1_bufferutil@4.1.0_typescript@5.9.3_utf-8-validate@6.0.6/node_modules/@solana/web3.js/lib/index.esm.js
init_ed25519();
...
*/
var publicKey$1 = (property = "publicKey") => {
...
var authorized = (property = "authorized") => {
	return import_Layout.struct([publicKey$1("staker"), publicKey$1("withdrawer")], property);
};
/**
...
var voteAuthorizeWithSeedArgs = (property = "voteAuthorizeWithSeedArgs") => {
	return import_Layout.struct([
		...
		publicKey$1("currentAuthorityDerivedKeyOwnerPubkey"),
		rustString("currentAuthorityDerivedKeySeed"),
		publicKey$1("newAuthorized")
	], property);
};
...
var Message = class Message {
	...
	serialize() {
		...
		const signDataLayout = import_Layout.struct([
			...
			import_Layout.seq(publicKey$1("key"), numKeys, "keys"),
			publicKey$1("recentBlockhash")
		]);
		const transaction = {
...
var MessageV0 = class MessageV0 {
	...
	serialize() {
		...
		const messageLayout = import_Layout.struct([
			...
			import_Layout.seq(publicKey$1(), this.staticAccountKeys.length, "staticAccountKeys"),
			publicKey$1("recentBlockhash"),
...
var TransactionMessage = class TransactionMessage {
	constructor(args) {
...
*/
var VersionedTransaction = class VersionedTransaction {
	get version() {
	...
	constructor(message, signatures) {
		...
		if (signatures !== void 0) {
			...
			for (let i = 0; i < message.header.numRequiredSignatures; i++) defaultSignatures.push(new Uint8Array(64));
...
var SYSTEM_INSTRUCTION_LAYOUTS = Object.freeze({
	Create: {
		...
		layout: import_Layout.struct([
			...
			publicKey$1("programId")
		])
	},
	Assign: {
		index: 1,
		layout: import_Layout.struct([import_Layout.u32("instruction"), publicKey$1("programId")])
	},
	Transfer: {
		index: 2,
		layout: import_Layout.struct([import_Layout.u32("instruction"), u64$1("lamports")])
	},
	CreateWithSeed: {
		index: 3,
		layout: import_Layout.struct([
	...
	InitializeNonceAccount: {
		index: 6,
		layout: import_Layout.struct([import_Layout.u32("instruction"), publicKey$1("authorized")])
	},
...
var fetchImpl = typeof globalThis.fetch === "function" ? globalThis.fetch : async function(input, init) {
	return await fetch$1(typeof input === "string" && input.slice(0, 2) === "//" ? "https:" + input : input, init);
};
...
var AddressLookupTableAccount = class {
	...
	static deserialize(accountData) {
		...
		const { addresses } = import_Layout.struct([import_Layout.seq(publicKey$1(), numSerializedAddresses, "addresses")]).decode(accountData.slice(LOOKUP_TABLE_META_SIZE));
		return {
...
var LookupTableMetaLayout = {
	...
	layout: import_Layout.struct([
		...
		import_Layout.u8(),
		import_Layout.seq(publicKey$1(), import_Layout.offset(import_Layout.u8(), -1), "authority")
	])
};
var URL_RE = /^[^:]+:\/\/([^:[]+|\[[^\]]+\])(:\d+)?(.*)/i;
...
var LOOKUP_TABLE_INSTRUCTION_LAYOUTS = Object.freeze({
	...
	ExtendLookupTable: {
		...
		layout: import_Layout.struct([
			import_Layout.u32("instruction"),
			u64$1(),
			import_Layout.seq(publicKey$1(), import_Layout.offset(import_Layout.u32(), -8), "addresses")
		])
	},
...
var COMPUTE_BUDGET_INSTRUCTION_LAYOUTS = Object.freeze({
	...
	SetComputeUnitPrice: {
		index: 3,
		layout: import_Layout.struct([import_Layout.u8("instruction"), u64$1("microLamports")])
	}
});
/**
...
import_Layout.struct([
	...
	import_Layout.nu64(),
	import_Layout.seq(import_Layout.struct([import_Layout.nu64("epoch"), publicKey$1("authorizedVoter")]), import_Layout.offset(import_Layout.u32(), -8), "authorizedVoters"),
	import_Layout.struct([
...
//#endregion
//#region ../../node_modules/.pnpm/@solana+spl-token@0.4.14_@solana+web3.js@1.98.1_bufferutil@4.1.0_typescript@5.9.3_utf-8_b31f5c229d165a628065dbaa4b1240bb/node_modules/@solana/spl-token/lib/esm/constants.js
...
//#endregion
//#region ../../node_modules/.pnpm/@solana+buffer-layout-utils@0.2.0_bufferutil@4.1.0_typescript@5.9.3_utf-8-validate@6.0.6/node_modules/@solana/buffer-layout-utils/lib/esm/base.mjs
...
//#endregion
//#region ../../node_modules/.pnpm/@solana+buffer-layout-utils@0.2.0_bufferutil@4.1.0_typescript@5.9.3_utf-8-validate@6.0.6/node_modules/@solana/buffer-layout-utils/lib/esm/bigint.mjs
var bigInt = (length) => (property) => {
	const layout = (0, import_Layout.blob)(length, property);
	...
	bigIntLayout.encode = (bigInt, buffer, offset) => {
		return encode(toBufferLE(bigInt, length), buffer, offset);
	};
	return bigIntLayout;
};
var u64 = bigInt(8);
//#endregion
//#region ../../node_modules/.pnpm/@solana+buffer-layout-utils@0.2.0_bufferutil@4.1.0_typescript@5.9.3_utf-8-validate@6.0.6/node_modules/@solana/buffer-layout-utils/lib/esm/native.mjs
var bool = (property) => {
	const layout = (0, import_Layout.u8)(property);
	const { encode, decode } = encodeDecode(layout);
	...
	boolLayout.encode = (bool, buffer, offset) => {
		return encode(Number(bool), buffer, offset);
	};
	return boolLayout;
};
//#endregion
//#region ../../node_modules/.pnpm/@solana+buffer-layout-utils@0.2.0_bufferutil@4.1.0_typescript@5.9.3_utf-8-validate@6.0.6/node_modules/@solana/buffer-layout-utils/lib/esm/web3.mjs
init_index_esm();
var publicKey = (property) => {
	const layout = (0, import_Layout.blob)(32, property);
	const { encode, decode } = encodeDecode(layout);
	const publicKeyLayout = layout;
	publicKeyLayout.decode = (buffer, offset) => {
		return new PublicKey$1(decode(buffer, offset));
	};
	publicKeyLayout.encode = (publicKey, buffer, offset) => {
		return encode(publicKey.toBuffer(), buffer, offset);
	};
	return publicKeyLayout;
};
//#endregion
//#region ../../node_modules/.pnpm/@solana+spl-token@0.4.14_@solana+web3.js@1.98.1_bufferutil@4.1.0_typescript@5.9.3_utf-8_b31f5c229d165a628065dbaa4b1240bb/node_modules/@solana/spl-token/lib/esm/errors.js
...
//#endregion
//#region ../../node_modules/.pnpm/@solana+spl-token@0.4.14_@solana+web3.js@1.98.1_bufferutil@4.1.0_typescript@5.9.3_utf-8_b31f5c229d165a628065dbaa4b1240bb/node_modules/@solana/spl-token/lib/esm/instructions/types.js
...
//#endregion
//#region ../../node_modules/.pnpm/@solana+spl-token@0.4.14_@solana+web3.js@1.98.1_bufferutil@4.1.0_typescript@5.9.3_utf-8_b31f5c229d165a628065dbaa4b1240bb/node_modules/@solana/spl-token/lib/esm/instructions/internal.js
/** @internal */
...
//#endregion
//#region ../../node_modules/.pnpm/@solana+spl-token@0.4.14_@solana+web3.js@1.98.1_bufferutil@4.1.0_typescript@5.9.3_utf-8_b31f5c229d165a628065dbaa4b1240bb/node_modules/@solana/spl-token/lib/esm/instructions/transferChecked.js
/** TODO: docs */
var transferCheckedInstructionData = (0, import_Layout.struct)([
	(0, import_Layout.u8)("instruction"),
	u64("amount"),
	(0, import_Layout.u8)("decimals")
]);
/**
...
(0, import_Layout.struct)([
	(0, import_Layout.u32)("mintAuthorityOption"),
	publicKey("mintAuthority"),
	u64("supply"),
	(0, import_Layout.u8)("decimals"),
	bool("isInitialized"),
	(0, import_Layout.u32)("freezeAuthorityOption"),
...
//#endregion
//#region ../../node_modules/.pnpm/@solana+spl-token@0.4.14_@solana+web3.js@1.98.1_bufferutil@4.1.0_typescript@5.9.3_utf-8_b31f5c229d165a628065dbaa4b1240bb/node_modules/@solana/spl-token/lib/esm/instructions/associatedTokenAccount.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+solana-core@4.89.0_@dynamic-labs-wallet+primitives@1.0.16_bufferutil@4.1._dc4aa6854ef4161dca3d011934dd96b7/node_modules/@dynamic-labs/solana-core/src/utils/createNonNativeTokenTransfer/createNonNativeTokenTransfer.js
var createNonNativeTokenTransfer = (_a) => __awaiter(void 0, [_a], void 0, function* ({ connection, fromAddress, toAddress, tokenAddress, amount, decimals, blockhash, lastValidBlockHeight }) {
	...
	const tokenProgramId = mintAccountInfo && mintAccountInfo.owner.equals(TOKEN_2022_PROGRAM_ID) ? TOKEN_2022_PROGRAM_ID : TOKEN_PROGRAM_ID;
	const fromTokenAccount = (_c = (_b = yield connection.getTokenAccountsByOwner(fromPublicKey, { mint: tokenPublicKey })) === null || _b === void 0 ? void 0 : _b.value[0]) === null || _c === void 0 ? void 0 : _c.pubkey;
...
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+solana-core@4.89.0_@dynamic-labs-wallet+primitives@1.0.16_bufferutil@4.1._dc4aa6854ef4161dca3d011934dd96b7/node_modules/@dynamic-labs/solana-core/src/utils/createSolTransfer/createSolTransfer.js
...
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+solana-core@4.89.0_@dynamic-labs-wallet+primitives@1.0.16_bufferutil@4.1._dc4aa6854ef4161dca3d011934dd96b7/node_modules/@dynamic-labs/solana-core/src/wallet/SolanaWallet.js
	...
	*/
	sendBalance(_a) {
		return __awaiter(this, arguments, void 0, function* ({ amount, toAddress, token }) {
			...
			if (token === null || token === void 0 ? void 0 : token.address) transaction = yield createNonNativeTokenTransfer({
				amount,
				blockhash,
				connection,
			...
			else transaction = yield createSolTransfer({
	...
	*/
	getSigner() {
		return __awaiter(this, void 0, void 0, function* () {
			...
			if (!signer) throw new Error("unable to retrieve Solana signer");
			try {
...
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+solana-core@4.89.0_@dynamic-labs-wallet+primitives@1.0.16_bufferutil@4.1._dc4aa6854ef4161dca3d011934dd96b7/node_modules/@dynamic-labs/solana-core/src/utils/extractNonce/extractNonce.js
var extractNonce = (messageToSign) => {
	const regex = messageToSign.match(/Nonce: (.*)/);
	if (regex && regex.length === 2) return regex[1];
};
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+solana-core@4.89.0_@dynamic-labs-wallet+primitives@1.0.16_bufferutil@4.1._dc4aa6854ef4161dca3d011934dd96b7/node_modules/@dynamic-labs/solana-core/src/utils/getOverrideRpcUrlForNetwork/getOverrideRpcUrlForNetwork.js
var getOverrideRpcUrlForNetwork = (connectionConfig, network) => {
	...
	let overrideRpcUrl;
	if (isSolanaNetwork) overrideRpcUrl = (_b = (_a = connectionConfig === null || connectionConfig === void 0 ? void 0 : connectionConfig.customRpcUrls) === null || _a === void 0 ? void 0 : _a.solana) === null || _b === void 0 ? void 0 : _b[0];
	if (isEclipseNetwork) overrideRpcUrl = (_d = (_c = connectionConfig === null || connectionConfig === void 0 ? void 0 : connectionConfig.customRpcUrls) === null || _c === void 0 ? void 0 : _c.eclipse) === null || _d === void 0 ? void 0 : _d[0];
	return overrideRpcUrl || ((_e = network.privateCustomerRpcUrls) === null || _e === void 0 ? void 0 : _e[0]) || network.rpcUrls[0];
};
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+solana-core@4.89.0_@dynamic-labs-wallet+primitives@1.0.16_bufferutil@4.1._dc4aa6854ef4161dca3d011934dd96b7/node_modules/@dynamic-labs/solana-core/src/constants.js
var DYNAMIC_SVM_NETWORK_ID_LS_KEY = "dynamic_svm_network_id";
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+solana-core@4.89.0_@dynamic-labs-wallet+primitives@1.0.16_bufferutil@4.1._dc4aa6854ef4161dca3d011934dd96b7/node_modules/@dynamic-labs/solana-core/src/utils/getBackwardsCompatibleSolNetworks/getBackwardsCompatibleSolNetworks.js
...
var getBackwardsCompatibleSolNetworks = (originalSolNetworks, connectionConfig) => {
	if (!(originalSolNetworks === null || originalSolNetworks === void 0 ? void 0 : originalSolNetworks.length)) return [];
	if (originalSolNetworks.length > 1 || originalSolNetworks[0].chainId !== "101") return originalSolNetworks;
	const rpcUrl = getOverrideRpcUrlForNetwork(connectionConfig, originalSolNetworks[0]);
	if (rpcUrl.includes("testnet")) return [Object.assign(Object.assign({}, SOLANA_TESTNET_NETWORK), { privateCustomerRpcUrls: [rpcUrl] })];
	if (rpcUrl.includes("devnet")) return [Object.assign(Object.assign({}, SOLANA_DEVNET_NETWORK), { privateCustomerRpcUrls: [rpcUrl] })];
	if (rpcUrl.includes("mainnet")) return [Object.assign(Object.assign({}, SOLANA_MAINNET_NETWORK), { privateCustomerRpcUrls: [rpcUrl] })];
	return originalSolNetworks;
};
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs+solana-core@4.89.0_@dynamic-labs-wallet+primitives@1.0.16_bufferutil@4.1._dc4aa6854ef4161dca3d011934dd96b7/node_modules/@dynamic-labs/solana-core/src/connector/SolanaWalletConnector.js
	...
	*/
	...
	endSession() {
		return __awaiter(this, void 0, void 0, function* () {
			...
			const signer = yield this.getSigner();
			if (signer) yield signer.disconnect();
		});
	}
	getWalletClient() {
		var _a;
		...
		return new Connection(getOverrideRpcUrlForNetwork(this.connectionConfig, network), (_a = this.connectionConfig) !== null && _a !== void 0 ? _a : "confirmed");
	}
	getPublicClient() {
		return __awaiter(this, void 0, void 0, function* () {
			var _a;
	...
	getBalance(address) {
		return __awaiter(this, void 0, void 0, function* () {
			...
			return this.lamportsToSol(yield this.getWalletClient().getBalance(publicKey)).toString();
		});
	}
	...
	signMessage(messageToSign) {
		const _super = Object.create(null, { signMessage: { get: () => super.signMessage } });
		return __awaiter(this, void 0, void 0, function* () {
			if (this.isHardwareWalletEnabled) throw new NotSupportedError(`Message signing is currently not supported on ${this.name} hardware wallet.
	...
	proveOwnership(address, messageToSign) {
		const _super = Object.create(null, { proveOwnership: { get: () => super.proveOwnership } });
		return __awaiter(this, void 0, void 0, function* () {
			yield this.validateActiveWallet(address);
			if (this.isHardwareWalletEnabled) {
				const nonce = extractNonce(messageToSign);
				if (!nonce) throw new DynamicError("Nonce missing");
	...
	signMessageViaTransaction(messageToSign) {
		return __awaiter(this, void 0, void 0, function* () {
			...
			if (!address) throw new DynamicError("Address missing");
			...
			const signer = yield this.getSigner();
			if (!signer) throw new DynamicError("Signer not found");
			const serializedSignedTransaction = (yield signer.signTransaction(transaction)).serialize();
			/**
...
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs-connectors+metamask-solana@4.6.8_@dynamic-labs+solana-core@4.89.0_@dynami_6c64b00fd7dcbc0ea9cbde32c29099d0/node_modules/@dynamic-labs-connectors/metamask-solana/src/MetaMaskSolanaSdkClient.js
var MetaMaskSolanaSdkClient = class {
	constructor() {
...
MetaMaskSolanaSdkClient.init = async (config) => {
	if (MetaMaskSolanaSdkClient.isInitialized) return;
	if (MetaMaskSolanaSdkClient.initPromise) return MetaMaskSolanaSdkClient.initPromise;
...
MetaMaskSolanaSdkClient.doInit = async (config) => {
	...
	try {
		const { createSolanaClient } = await import("../@metamask/connect-solana+[...].mjs").then((n) => n.t);
...
MetaMaskSolanaSdkClient.connect = async () => {
	...
	if (!wallet) throw new Error("[MetaMaskSolanaSdkClient] Not initialized. Call init() first.");
	...
	if (!connectFn) throw new Error("[MetaMaskSolanaSdkClient] Wallet does not support standard:connect");
	const firstAccount = (await connectFn({ silent: false })).accounts[0];
...
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs-connectors+metamask-solana@4.6.8_@dynamic-labs+solana-core@4.89.0_@dynami_6c64b00fd7dcbc0ea9cbde32c29099d0/node_modules/@dynamic-labs-connectors/metamask-solana/src/WalletStandardAdapter.js
function createWalletStandardAdapter(wallet, getSelectedNetwork) {
	const features = wallet.features;
	const getCurrentAccount = () => {
		const account = wallet.accounts[0];
		if (!account) throw new Error("[WalletStandardAdapter] No connected account");
		return account;
	};
	const getChain = () => {
		return `solana:${getSelectedNetwork()}`;
	};
	const connect = async () => {
		...
		if (!connectFn) throw new Error("[WalletStandardAdapter] standard:connect not supported");
		const result = await connectFn({ silent: false });
		if (!result.accounts[0]) return void 0;
		return {
	...
	const signTransaction = async (transaction) => {
		...
		if (!signFn) throw new Error("[WalletStandardAdapter] solana:signTransaction not supported");
		const account = getCurrentAccount();
		const serializedTransaction = transaction.serialize({ requireAllSignatures: false });
		const signed = (_result_ = (await signFn({
			account,
			chain: getChain(),
			transaction: Uint8Array.from(serializedTransaction)
		}))[0]) == null ? void 0 : _result_.signedTransaction;
		if (!signed) throw new Error("[WalletStandardAdapter] No signed transaction returned");
		if (!("instructions" in transaction)) return VersionedTransaction.deserialize(signed);
	...
	const signAndSendTransaction = async (transaction) => {
		...
		if (!sendFn) throw new Error("[WalletStandardAdapter] solana:signAndSendTransaction not supported");
		const account = getCurrentAccount();
		const serializedTransaction = transaction.serialize({ requireAllSignatures: false });
		const sig = (_result_ = (await sendFn({
			account,
			chain: getChain(),
			transaction: Uint8Array.from(serializedTransaction)
		}))[0]) == null ? void 0 : _result_.signature;
		if (!sig) throw new Error("[WalletStandardAdapter] No signature returned");
		return { signature: esm_default.encode(sig) };
	};
	const signMessage = async (message) => {
		...
		if (!signFn) throw new Error("[WalletStandardAdapter] solana:signMessage not supported");
		const sig = (_result_ = (await signFn({
	...
	return {
		...
		get publicKey() {
			const account = wallet.accounts[0];
			if (!(account == null ? void 0 : account.publicKey)) return void 0;
...
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs-connectors+metamask-solana@4.6.8_@dynamic-labs+solana-core@4.89.0_@dynami_6c64b00fd7dcbc0ea9cbde32c29099d0/node_modules/@dynamic-labs-connectors/metamask-solana/src/MetaMaskSolanaWalletConnector.js
function _extends() {
...
var MetaMaskSolanaWalletConnector = class extends SolanaWalletConnector {
	isInstalledOnBrowser() {
	...
	async init() {
		...
		try {
			await MetaMaskSolanaSdkClient.init({ dappName: "Dynamic" });
		} catch (error) {
	...
	setupEventListeners() {
		...
		const unsubscribe = onFn("change", (properties) => {
			...
			handleAccountChange(properties.accounts.map((a) => a.address));
		});
	...
	async connect() {
		if (!MetaMaskSolanaSdkClient.isInitialized) await this.init();
		await MetaMaskSolanaSdkClient.connect();
		this.signer = this.buildSigner();
	}
	async getSigner() {
		if (!this.signer) this.signer = this.buildSigner();
		return this.signer;
	}
	...
	async getAddress(opts) {
		...
		if (!MetaMaskSolanaSdkClient.isInitialized) await this.init();
		const unsubscribe = (opts == null ? void 0 : opts.onDisplayUri) ? MetaMaskSolanaSdkClient.onDisplayUri(opts.onDisplayUri) : void 0;
		try {
	...
	async getConnectedAccounts() {
		if (!MetaMaskSolanaSdkClient.isInitialized) try {
			await this.init();
		} catch (e) {}
		...
		if (wallet) try {
			...
			if (connectFn) {
				...
				if (result.accounts.length) return result.accounts.map((a) => a.address);
			}
		} catch (e) {}
		return [];
	}
	...
	buildSigner() {
		const wallet = MetaMaskSolanaSdkClient.getWallet();
		logger.logVerboseTroubleshootingMessage("[MetaMaskSolanaWalletConnector] buildSigner", { wallet });
		if (!wallet) return;
...
//#endregion
//#region ../../node_modules/.pnpm/@dynamic-labs-connectors+metamask-solana@4.6.8_@dynamic-labs+solana-core@4.89.0_@dynami_6c64b00fd7dcbc0ea9cbde32c29099d0/node_modules/@dynamic-labs-connectors/metamask-solana/src/index.js
var MetaMaskSolanaWalletConnectors = (_props) => [MetaMaskSolanaWalletConnector];
//#endregion
export { walletConnectorEvents as A, isSamsungBrowser as B, findWalletBookWallet as C, __awaiter$1 as D, getWalletBookWallet as E, isIPhone as F, NotSupportedError as G, __awaiter$2 as H, isIPhone8OrEarlier as I, Logger as J, DynamicError as K, isLegacySafari as L, isAndroid as M, isIOS as N, isSameAddress as O, isIPad as P, isMobile as R, isWalletBookPopulated as S, getIconicSpriteUrl as T, __classPrivateFieldGet$1 as U, PlatformService as V, __classPrivateFieldSet as W, eventemitter3_default as X, LogLevel as Y, import_eventemitter3 as Z, Transaction as _, DYNAMIC_SVM_NETWORK_ID_LS_KEY as a, WalletConnectorBase as b, createAssociatedTokenAccountInstruction as c, TOKEN_2022_PROGRAM_ID as d, TOKEN_PROGRAM_ID as f, SystemProgram as g, PublicKey as h, getBackwardsCompatibleSolNetworks as i, getAndroidVersion as j, logger as k, getAssociatedTokenAddress as l, LAMPORTS_PER_SOL as m, esm_default as n, getOverrideRpcUrlForNetwork as o, Connection as p, CustomError as q, SolanaWalletConnector as r, SolanaWallet as s, MetaMaskSolanaWalletConnectors as t, createTransferCheckedInstruction as u, VersionedTransaction as v, renderTemplate as w, getWalletMetadataFromWalletBook as x, __awaiter as y, isSafariBrowser as z };
